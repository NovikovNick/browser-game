...
export default function Enemy({gameObject, color}) {

    const angleRadian = gameObject.rot;
    ...
    return (
        <g>
            <Ship color={color} isEnemy={true} center={gameObject.pos} angleDegree={angleDegree}/>

            {debug && <Polygon polygon={gameObject.shape} color={color} empty={true}/>}
        </g>
    );
}
